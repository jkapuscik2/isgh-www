...
<?php include_once("analyticstracking.php") ?>
    ...
    <div class="jumbotron">
	  <div class="container">
        <h1>Jak korzystać?</h1>
        <p>Poniżej znajdziesz instrukcje dodawania planu zajęć i-sgh.pl do najbardziej popularnych aplikacji.</p>
      </div>
    </div>
	...
	<div class="container">
			...
			<div class="panel panel-default">
				...
				<div id="collapseOne" class="panel-collapse collapse in">
					<div class="panel-body">
						...
						<li>W górnym menu przejdź do zakładki <strong>kalendarz</strong></li>
						...
						<li>W polu "Kalendarz internetowy" wklej Link do swojego kalendarza i kliknij "Otwórz"</li>
						</ol>
					</div>
				</div>
			</div>
		...
		<div class="panel-body">
		<ol>
		<li><a href="http://calendar.google.com" target="blank">
		Zaloguj się</a> na swoje konto Google Calendar</li>
		<li>Rozwiń menu przy liście <strong>Inne kalendarze</strong> w panelu po lewej stronie ekranu i wybierz pozycję <strong>Dodaj wg adresów URL</strong></li>
		<li>W polu <strong>Adres URL</strong> wklej Link do swojego kalendarza i zatwierdź przyciskiem <strong>Dodaj kalendarz</strong></li>
		</ol>
		</div>
		</div>
		</div>
