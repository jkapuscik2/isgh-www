...
if ($client->getAccessToken()) {
	...
	//Google API Auth END
	$get_primary_id = $cal->calendars->get('primary');
	$google_email = $get_primary_id->getId();
	$email_state = "disabled";
	include ("select-content.php");
  ...
  $google_email = "Your e-mail address";
  $email_state = "required";
  include ("select-content.php");
