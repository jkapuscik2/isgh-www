...
class Google_LiveBroadcast extends Google_Model {
  ...
  protected $__snippe $this->channelId = $channelId;
  }
  public function getChannelId() {
    return $this->channelId;
  }
