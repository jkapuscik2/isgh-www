...
<script>(function(d, s, id) {
  ...
  fjs.parentNode.insertBefore(js, fjs);
    ...
    <div class="jumbotron">
	  <div class="container">
        <h1>Events and paramount deadlines.</h1>
        <p>Apart from schedule we provide priceless information on events involving SGH society and i.e. deadlines for applications.</p>
      </div>
    </div>
	...
	<div class="container">
		...
		<p>If you've created your schedule using Google account mentioned calendars have been automatically added to you account and you can view them at <a href="http://calendar.google.com" class="alert-link">calendar.google.com.</a>
		</p>
		</div>
		...
		<table id="przedmioty_lista" class="table table-bordered table-hover">
			<tr>
				<th>Name</th>
				<th>ICS link (licencjackie)</th>
				<th>ICS link (magisterskie)</th>
			</tr>
			<?php echo $line_lista;?>
		</table>
