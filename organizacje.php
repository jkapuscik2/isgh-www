...
<script>(function(d, s, id) {
  ...
  fjs.parentNode.insertBefore(js, fjs);
    ...
    <div class="jumbotron">
	  <div class="container">
        <h1>Dla organizacji studenckich.</h1>
        <p>i-sgh.pl to nowy sposób na promocję wydarzeń. Zapisz swoją organizację - wkrótce prześlemy więcej informacji.</p>
	...
	<div class="container">
		...
		<div class="mc-field-group">
			<label for="mce-EMAIL">Adres e-mail organizacji </label>
			<input type="email" value="" name="EMAIL" class="required email" id="mce-EMAIL">
		</div>
		<div class="mc-field-group">
			<label for="mce-FNAME">Nazwa organizacji </label>
